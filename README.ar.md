...
لهذا الإحباط صنعت **Panel 052**. هو لا يضع قالباً فوق الصورة؛ بل يحدد أولاً ما لا يجوز فقدانه، ثم يترجمه إلى **جعل عالم مصغّر يدوي يطفو على خط منظر واحد**.
...
<table>
  ...
  <tr>
    <td colspan="2"><img src="./assets/examples/sample-05.png" alt="XXD Panel 052 نموذج 5"></td>
  </tr>
  <tr>
    <td width="33%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 052 نموذج 6"></td>
    <td width="33%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 052 نموذج 7"></td>
    <td width="33%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 052 نموذج 8"></td>
  </tr>
</table>
